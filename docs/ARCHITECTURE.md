# LumaSift Android Architecture

## Purpose and User Outcome

The Android edition uses Kotlin, Jetpack Compose, and Android secure storage. Its intended outcome is a comprehensible, safe duplicate-resolution experience that keeps user-selected categories, progress, proof evidence, and recovery state visible at every stage.
